...
#SBATCH --mem=4000M        # Memory proportional to GPUs: 32000 Cedar, 64000 Graham.
#SBATCH --time=0-00:40
#SBATCH --output=out_stokes_i.out
...
python -u -m scripts.run_training -c config_stokes_i_gpu
